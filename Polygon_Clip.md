...
![image-20211111080648502](Polygon_Clip.assets/image-20211111080648502.png)



- 内裁剪：内裁剪即通常意义上的裁剪，取图元位于窗口之内的部分，结果为A∩B。

![image-20211111080700149](Polygon_Clip.assets/image-20211111080700149.png)
...
![image-20211109100429833](Polygon_Clip.assets/image-20211109100429833.png)
...
![image-20211109100234792](Polygon_Clip.assets/image-20211109100234792.png)



# 2. 算法步骤

![image-20211109100745109](Polygon_Clip.assets/image-20211109100745109.png)
...
![image-20211109101620822](Polygon_Clip.assets/image-20211109101620822.png)

## 2.2 求主多边形和裁剪多边形的交点，并将这些交点按顺序插入两个多边形的顶点表中。在两多边形顶点表中的相同交点间建立双向指针。

![image-20211109101651592](Polygon_Clip.assets/image-20211109101651592.png)
...
![image-20211109103351760](Polygon_Clip.assets/image-20211109103351760.png)
...
![image-20211110220037198](Polygon_Clip.assets/image-20211110220037198.png)
...
![image-20211110164522234](Polygon_Clip.assets/image-20211110164522234.png)
...
![image-20211110204111101](Polygon_Clip.assets/image-20211110204111101.png)

### 后

![image-20211110204041400](Polygon_Clip.assets/image-20211110204041400.png)
...
![image-20211109104435875](Polygon_Clip.assets/image-20211109104435875.png)
